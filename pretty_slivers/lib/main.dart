...
class HorizonsApp extends StatelessWidget {
  ...
  SliverAppBar weatherSliverAppBar() {
    return SliverAppBar(
      stretch: true,
      ...
      // floating: true,
      // snap: true, // Used together wight floating: true
    );
  } // End of build()
} // End of HorizonApp
...
class WeeklyForecastList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SliverList(
      /// A SliverList takes a SliverChildDelegate, which provides the children.
      /// One kind of SliverChildDelegate is a SliverChildBuilderDelegate,
      /// which is the same as the builder provided in the ListView.
      delegate: SliverChildBuilderDelegate(
        /// Start of the function that builds every row into a crollable element
        /// Same as item builder in a ListView.builder()
...
} // End of WeeklyForecastList class
